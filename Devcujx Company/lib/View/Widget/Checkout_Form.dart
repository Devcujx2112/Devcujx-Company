...
import 'package:order_food/View/Widget/DialogPayment.dart';
    ...
    final result = await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return DialogPayment(
          ...
          addressUser: _addressController.text,
          nameUser: _nameController.text,
          phoneUser: _phoneController.text,
          dataCart: widget.dataCart,onPaymentSuccess: widget.onPaymentSuccess,
        );
      },
    );
    if (result == true) {
