...
class _DialogChangePasswordState extends State<DialogChangePassword> {
  ...
  void _changePassword() async {
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      bool isSuccess = await authVM.ChangePassword(
          _oldPasswordController.text, _newPasswordController.text, uid);
      if (isSuccess) {
        Navigator.pop(context);
        showDialogMessage(
            context, "Đổi mật khẩu thành công", DialogType.success);
      } else {
        showDialogMessage(context,
            "Đổi mật khẩu thất bại ${authVM.errorMessage}", DialogType.error);
        setState(() {
          _isLoading = false;
        });
      }
